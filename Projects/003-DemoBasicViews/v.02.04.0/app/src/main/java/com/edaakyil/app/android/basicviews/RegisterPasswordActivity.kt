...
private const val REGISTER_USER_INFO = "REGISTER_USER_INFO"
...
class RegisterPasswordActivity : AppCompatActivity() {
    ...
    private fun registerUser() {
        try {
            ObjectOutputStream(FileOutputStream(File(filesDir, USERS_FILE_PATH), true)).use { it.writeObject(mRegisterInfo) }
            File(filesDir, USERS_FORMAT.format("${mRegisterInfo.username}.txt")).delete()
