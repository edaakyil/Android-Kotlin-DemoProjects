...
class RegisterInfoActivity : AppCompatActivity() {
    ...
    private fun selectOptionIfUserSaved() {
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton(R.string.alert_dialog_update) { _, _ -> }
    ...
    fun onCloseButtonClicked(view: View) {
        ...
        if (username.isNotBlank()) {
            val dlg = AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.alert_dialog_save) { _, _ -> saveRegisterInfo(); finish() }
