...
import com.edaakyil.app.android.basicviews.model.LoginInfoModel
...
class MainActivity : AppCompatActivity() {
    ...
    private fun fillLoginInfoModel() {
        ...
        mLoginInfoModel  = LoginInfoModel(username, password, )
    }
        ...
        if (!mCheckBoxAnonymous.isChecked) {
            ...
            if (checkUser())
                Intent(this, ManagementActivity::class.java).apply {
                    putExtra(USERNAME, mLoginInfoModel.username)
                    putExtra(PASSWORD, mLoginInfoModel.password)
                    startActivity(this)
                }
            else
    ...
    private fun loginButtonClickedCallback() = doLogin()
    ...
    fun onClearUsernameTextButtonClicked(view: View) = mEditTextUsername.text.clear()
    ...
    fun onRegisterButtonClicked(vew: View) = Intent(this,RegisterInfoActivity::class.java).apply { startActivity(this) }
