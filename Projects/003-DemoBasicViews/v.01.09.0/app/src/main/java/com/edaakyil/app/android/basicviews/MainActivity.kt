...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var mButtonClearUsername: Button // edaakyil
    private lateinit var mButtonClearPassword: Button // edaakyil
    ...
    private fun anonymousCheckBoxCheckedChangeCallback(isChecked: Boolean) {
        mEditTextUsername.isEnabled = !isChecked
        mEditTextPassword.isEnabled = !isChecked
        mButtonClearAll.isEnabled = !isChecked
        mButtonClearUsername.isEnabled = !isChecked
        mButtonClearPassword.isEnabled = !isChecked
    }
    ...
    private fun initViews() {
        ...
        mButtonClearUsername = findViewById(R.id.mainActivityButtonClearUsername) // edaakyil
        mButtonClearPassword = findViewById(R.id.mainActivityButtonClearPassword) // edaakyil
