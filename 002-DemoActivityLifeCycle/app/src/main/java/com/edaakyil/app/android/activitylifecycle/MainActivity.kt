package com.edaakyil.app.android.activitylifecycle
...
class MainActivity : AppCompatActivity() {
    ...
    private fun prompt(resId: Int, time: LocalTime) {
        val toast = Toast.makeText(this, resources.getString(resId).format(mFormatter.format(time)), Toast.LENGTH_LONG)
    ...
    override fun onDestroy() {
        super.onDestroy()
        prompt(R.string.on_destroy_messge, LocalTime.now())
    }
}